	...
	def inThread_redraw_accwindow(self):
		...
		if self.ACCWINDOW_OPEN == True:
			try:
				...
				#self.debug(text="def inThread_redraw_accwindow: True")
			except:
				self.debug(text="def inThread_redraw_accwindow: recreate failed")
		return
