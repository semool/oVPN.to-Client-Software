...
def setup_data():
	data = { 
			...
			"py2exe_includes" : [ 'gi','win32process','requests','cairo','types','os','platform','sys','hashlib','random','time','zipfile','subprocess','threading','socket','random','gettext','locale','base64','zlib','netifaces','ctypes' ],
